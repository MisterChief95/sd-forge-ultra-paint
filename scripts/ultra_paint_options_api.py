...
from ultra_paint.settings_api import (
    SETTINGS_ROUTE,
...
def on_app_started(_demo: Blocks | None, app: FastAPI) -> None:
    ...
    app.add_api_route(SETTINGS_ROUTE, get_generation_settings, methods=["GET"])
    app.add_api_route(SETTINGS_ROUTE, save_generation_settings, methods=["PUT"])
